...
public class C2_Varargs01 {
	...
	public static void main(String[] args) {
		...
		toplama(2, 3); // iki sayinin toplami method'u
		toplama(2, 5, 8); // uc sayinin toplami method'u calisir
		// istedigimiz kadar yazabilecegimiz method'u olusturabilmemiz icin, Java
		// varargs olusturmus
