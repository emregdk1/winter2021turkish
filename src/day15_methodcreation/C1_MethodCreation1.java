...
public class C1_MethodCreation1 {
	...
	public static void main(String[] args) {
		// Soru 1 ) Kullanicidan bir sayi alin. Bu sayinin negatif veya pozitif oldugunu
		// tek mi cift mi oldugunu
		// ve uc basamakli veya daha buyukse,onlar ve yuzler basamagindaki rakamlarin
		// toplamini,
	...
	public static void pozitifNegatif(int sayi) { // parametre yazarken data tipini yazmaliyiz
