...
public class Exceptions03 {
	...
	public static void main(String[] args) {
		...
		// esitligin solundaki Exceptions01, hem class adi hem de exp objesi
		// icin data turu
		...
		try {
			...
			// bu durumda hem java'ya sorunu yazmasi icin firsaat vermis
			// hem de aplication'i bloke etmemis olurz
			 ...
			 * day38_exceptions.Exceptions03.main(Exceptions03.java:16)
			 * 
			 */
		}
		
		System.out.println("Kodun bloke olmamissssss");
