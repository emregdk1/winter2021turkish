...
public class C2_ModulusOperatoru {
	...
	public static void main(String[] args) {
		...
		// 15 tek mi çift mi ? 15/2 kalan=1
		// 25 3'bolunur mu? 25/3 kalan=1
		// hergangi bir sayinin 7 ile bolunebildigini kontrol etmek icin
		...
		// yuzler basamagýný bulmak icin bir kere daha ayný islemi yapýyorum
		
		sayi /=10; // bu satirla onlar  basamagindan kurtulurum
