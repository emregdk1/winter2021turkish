...
public class C6_Substring {
	...
	public static void main(String[] args) {
		...
		// subString(0,10) yazildiginda, 0 inclusive, 10 exclusive
		
		// 11.ci karakterden sonuna kadar olan String'i yazdiralim
		...
		// baslangic index'i olsun der ama bitis indexi olmasin der
